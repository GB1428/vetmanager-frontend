...
export function NuevoPacienteForm() {
  ...
  const [cargandoDuenos, setCargandoDuenos] = useState(true);
  ...
  useEffect(() => {
    listarDuenos()
      .then(setDuenos)
      .catch(() => setDuenos([]))
      .finally(() => setCargandoDuenos(false));
  }, []);
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button type="submit" form="nuevo-paciente-form" className="rounded-full" disabled={enviando}>
            ...
            <div className="space-y-2">
              ...
              {duenos.length > 0 ? (
                ...
                <div className="flex h-10 w-full items-center rounded-lg border border-dashed border-input bg-secondary/30 px-3 text-sm text-muted-foreground">
                  {cargandoDuenos ? "Cargando tutores..." : "No hay tutores registrados todavía"}
                </div>
              )}
            ...
            <div className="grid gap-6 lg:grid-cols-[220px_1fr]">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="mascota-microchip" name="mascotaMicrochip" type="number" placeholder="Ej: 981020002849182" />
                </div>
                <div className="space-y-2">
