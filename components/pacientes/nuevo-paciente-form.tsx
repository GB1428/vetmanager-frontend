...
<<<<<<< HEAD
  ...
  await fetch(`${API_URL}/mascotas`, {
    ...
    body: JSON.stringify({
      ...
      sexo,
      fecha_nacimiento: datos.mascotaFechaNacimiento,
      peso: Number(datos.mascotaPesoKg),
      observaciones: datos.motivoIngreso,
      antecedentes: datos.motivoIngreso,
      microchip: Number(datos.mascotaMicrochip),
      alergias,
